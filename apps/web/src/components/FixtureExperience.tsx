...
import { createHttpExperienceClient } from "../features/experience/client";
import type {
...
export const FixtureExperience = ({ client: injectedClient }: FixtureExperienceProps = {}) => {
