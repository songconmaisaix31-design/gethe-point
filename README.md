...
Follow [docs/demo/FOUR_MINUTE_DEMO.md](docs/demo/FOUR_MINUTE_DEMO.md). Canonical screenshots for the three roles at 1440, 820, and 390 pixels are in [docs/demo/screenshots](docs/demo/screenshots).
